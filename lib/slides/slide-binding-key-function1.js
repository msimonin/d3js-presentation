(function(){
  ...
  var container = d3.select("#slide-binding-key-function1 .container")
  ...
  container.append("a")
  .attr("href", "../lib/slides/slide-binding-key-function1.js")
  .attr("target", "_blank")
  .append("button")
  .attr("class", "btn btn-default")
  .text("source");
  ...
  */
  ...
  var circleGroup = svg.select("#circle-group-binding-key-function1");
  ...
  function transitionKeyFunction(datas) {
    ...
    var texts = svg.selectAll("text")
      .data(datas, function(d){return d.id});
    ...
    texts.transition()
      .duration(delay1)
      .delay(delay)
      .attr("x", function(d,i) {return centers[d.id]})
      .attr("y", 150)
      .attr("opacity", 0.3)
